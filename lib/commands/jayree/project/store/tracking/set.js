...
class RevisionInfo extends SfCommand {
    async run() {
...
RevisionInfo.summary = messages.getMessage('summary');
RevisionInfo.examples = [
...
RevisionInfo.requiresProject = true;
RevisionInfo.deprecateAliases = true;
RevisionInfo.aliases = ['jayree:source:tracking:store:set'];
